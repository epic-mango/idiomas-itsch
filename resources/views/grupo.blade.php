                        ...
                        <div class="col-sm">
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    {!! $errors->first('ID_GRUPO_NOMBRE','<span
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" name="GRUPO_SEMESTRE" value="{{ old('GRUPO_SEMESTRE') }}"
                                                pattern="[0-9]{1,11}" maxlength="11"
                                                class="form-control form-control-sm" placeholder="Semestre" required>
