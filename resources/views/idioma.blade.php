                ...
                <td>
                    <center>
                        <a type="button" class="btn btn-primary "
                            href="{{ route('update.mostidioma_modificar',$item->ID_IDIOMA) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <a type="button" class="btn btn-danger"
                            href="{{ route('delete.idioma_eliminar',$item->ID_IDIOMA) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
<!--INICIO CUADRO SALIDA AGREGAR IDIOMA-->
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('insert.agregar-idioma') }}" method="POST">
                @csrf
                <div class="container">
                        ...
                        <div class="col-sm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="IDIOMA_NOMBRE" pattern="[a-zZ-A]{1,30}" maxlength="30"
                                    ...
                                    value="{{ old('	IDIOMA_NOMBRE') }}" required>
