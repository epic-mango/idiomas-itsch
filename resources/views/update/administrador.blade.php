...
<!--Cuadro a Salir para Modificar admin-->
...
<div class="modal-dialog modal-xl">
    <div class="modal-content">
        ...
        <form action="{{ route('update.modoficar-admin', $informacion->ID_ADMIN ) }}" method="POST">
            @method('PATCH')
            @csrf
            <div class="container">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ID_ADMIN" value="{{ $informacion->ID_ADMIN }}"
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ADMIN_CLAVE" value="{{ $informacion->ADMIN_CLAVE }}"
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ADMIN_NOMBRE" value="{{ $informacion->ADMIN_NOMBRE }}"
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ADMIN_AP_PAT" value="{{ $informacion->ADMIN_AP_PAT }}"
                                        class="form-control form-control-sm" pattern="[a-zZ-A]{1,30}" maxlength="30"
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ADMIN_AP_MAT" value="{{ $informacion->ADMIN_AP_MAT }}"
                                        class="form-control form-control-sm" pattern="[a-zZ-A]{1,30}" maxlength="30"
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <select class="form-control  form-control-sm" name="ADMIN_SEXO"
                                        ...
                                        <opcion>{{ $informacion->ADMIN_SEXO }}</opcion>
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" name="ADMIN_TIPO_SANGRE"
                                        ...
                                        <option>{{$informacion->ADMIN_TIPO_SANGRE }}</option>
                                        <option>A+</option>
                                        <option>A-</option>
                                        <option>B+</option>
                                        <option>B-</option>
                            ...
                            <div class="col-sm">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control form-control-sm" name="ADMIN_FECHA_NAC" type="date"
                                        value="{{ $informacion->ADMIN_FECHA_NAC }}" id="example-date-input">
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="ADMIN_CALLE"
                                        value="{{  $informacion->ADMIN_CALLE }}" maxlength="30" placeholder="Calle"
                                        required>
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" maxlength="30"
                                        name="ADMIN_COLONIA" value="{{  $informacion->ADMIN_COLONIA }}"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" name="ADMIN_ESTADO"
                                        id="exampleFormControlSelect1">
                                        <option>{{ $informacion->ADMIN_ESTADO }}</option>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" maxlength="30"
                                        name="ADMIN_MUNICIPIO" value="{{ $informacion->ADMIN_MUNICIPIO }}"
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control form-control-sm" pattern="[0-9]{1,30}"
                                            maxlength="30" name="ADMIN_MOVIL" value="{{ $informacion->ADMIN_MOVIL }}"
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control form-control-sm" name="ADMIN_CASA"
                                            value="{{ $informacion->ADMIN_CASA }}" pattern="[0-9]{1,30}" maxlength="30"
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        ...
                                        <input maxlength="30" type="text" class="form-control" name="ADMIN_CORREO"
                                            value="{{ $informacion->ADMIN_CORREO }}" id="exampleFormControlInput1"
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm"
                                        ...
                                        value="{{ $informacion->ADMIN_CLAVE_PROFESIONAL }}" maxlength="30"
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="ADMIN_ESPECIALIDAD"
                                        value="{{ $informacion->ADMIN_ESPECIALIDAD }}" pattern="[A-Za-z]{1,30}"
                            ...
                            <div class="col-sm">
                                ...
                                <input class="form-control form-control-sm" type="date" name="ADMIN_FECHA_ING"
                                    value="{{ $informacion->ADMIN_FECHA_ING }}" id="example-date-input">
                            </div>
                        </div>
                            ...
                            <div class="col-sm">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1"
                                        ...
                                        rows="3">{{ $informacion->ADMIN_OBSERVACIONES }}</textarea>
                                </div>
                            </div>
            ...
            <div class="modal-footer">
                <a type="button" href="/administrativo" class="btn btn-secondary" data-dismiss="modal">Cerrar</a>
