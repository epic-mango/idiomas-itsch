...
@section('contenido-main')
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $informacion->ID_ADMIN }}" name="ADMIN_ID"
                                    ...
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ADMIN_NOMBRE"
                                                value="{{ $informacion->ADMIN_NOMBRE }}"
                                    ...
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ADMIN_AP_PAT"
                                                value="{{ $informacion->ADMIN_AP_PAT }}"
                                                class="form-control form-control-sm" pattern="[a-zZ-A]{1,30}" maxlength="30"
                                    ...
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ADMIN_AP_MAT"
                                                value="{{ $informacion->ADMIN_AP_MAT }}"
                                                class="form-control form-control-sm" pattern="[a-zZ-A]{1,30}" maxlength="30"
                                    ...
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="ADMIN_CALLE"
                                                value="{{ $informacion->ADMIN_CALLE }}" maxlength="30"
                                        ...
                                        <div class="col-sm">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control form-control-sm" name="ADMIN_CASA"
                                                    value="{{ $informacion->ADMIN_CASA }}" pattern="[0-9]{1,30}"
                                        ...
                                        <div class="col-sm">
                                            <div class="form-group">
                                                ...
                                                <input maxlength="30" type="text" class="form-control"
                                                    value="{{ $correo }}" placeholder="name@example.com" disabled>
    ...
    '<span
                                    ...
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                name="ADMIN_ESPECIALIDAD" value="{{ $informacion->ADMIN_ESPECIALIDAD }}"
                                                pattern="[A-Za-z]{1,30}" maxlength="30" placeholder="Especialidad">
                                            {!! $errors->first('ADMIN_ESPECIALIDAD', '<span class="alert-danger">:message</span><br>') !!}
                                        </div>
                                    </div>
                                    <div class="col-sm">
    ...
    <div class="modal-footer">
        <a type="button" href="{{ route('admin.actualizado') }}" class="btn btn-secondary"
