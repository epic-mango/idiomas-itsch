    ...
    '<span
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="ALUMNO_COLONIA" value="{{ old('ALUMNO_COLONIA') }}"
                                        ...
                                        <div class="col-sm">
                                            <div class="form-group">
                                                ...
                                                <input name="ALUMNO_TELEFONO_PER"
                                                    value="{{ old('ALUMNO_TELEFONO_PER') }}" type="tel" maxlength="30"
                                        ...
                                        <div class="col-sm">
                                            <div class="form-group">
                                                ...
                                                <input name="ALUMNO_TELEFONO_CASA"
                                                    value="{{ old('ALUMNO_TELEFONO_CASA') }}" type="tel" maxlength="30"
                                                    pattern="[0-9]{1,30}" class="form-control form-control-sm"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm">
                                            <div class="form-group">
                                                ...
                                                <input name="ALUMNO_CORREO" value="{{ old('ALUMNO_CORREO') }}"
                                        ...
                                        <div class="col-sm">
                                            <div class="form-group">
                                                ...
                                                <input name="ALUMNO_TUTOR_NOMBRE"
                                                    value="{{ old('ALUMNO_TUTOR_NOMBRE') }}" type="text"
                                        ...
                                        <div class="col-sm">
                                            <div class="form-group">
                                                ...
                                                <input name="ALUMNO_TUTOR_AR_PAT"
                                                    value="{{ old('ALUMNO_TUTOR_AR_PAT') }}" type="text"
                                                    pattern="[a-zZ-A]{1,30}" class="form-control form-control-sm"
                                        ...
                                        <div class="col-sm">
                                            <div class="form-group">
                                                ...
                                                <input name="ALUMNO_TUTOR_AR_MAT"
                                                    value="{{ old('ALUMNO_TUTOR_AR_MAT') }}" type="text"
                                                    pattern="[a-zZ-A]{1,30}" class="form-control form-control-sm"
